...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--input",
        type=str,
        default="data/test_core_extraction_unified_std_api.json",
        help="输入的知识图谱 JSON 文件路径（默认：data/test_core_extraction_unified_std_api.json）",
    )
    parser.add_argument(
        "--output",
        type=str,
        default="data/test_graph_with_vectors.json",
        help="输出的带向量索引的 JSON 文件路径（默认：data/test_graph_with_vectors.json）",
    )
    parser.add_argument(
        "--embedding-model",
        type=str,
